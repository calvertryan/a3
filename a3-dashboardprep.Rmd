...
Make sure to download the `censusapi` R package using Tools > Install Packages, similar to what you did in A1.
...
```{r API key}
Sys.setenv(CENSUS_KEY="INSERTKEYHERE")
```
